  ...
  $.getScript('js/common.js', function() {
    ...
    function fillSheet(pjs) {
        ...
        $tbd.append($('<tr style="background-color: lightGray"/>').append(
            ...
            $('<td>' + (t11*100).toFixed(1) + '%</td>'),
            $('<td>' + (t12*100).toFixed(1) + '%</td>'),
            $('<td>' + t13 + '</td>'),
            $('<td>' + t14 + '</td>'),
            $('<td>' + t15 + '</td>'),
            $('<td>' + t16 + '</td>'),
        ...
        for (var i = 0; i < pjs.length; i++) {
            ...
            $tbd.append($('<tr/>').append(
                ...
                $('<td>' + (pj.exitRatio*100).toFixed(1) + '%</td>'),
                $('<td>' + (pj.leaveRatio*100).toFixed(1) + '%</td>'),
