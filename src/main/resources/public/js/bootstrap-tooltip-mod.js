...
!function( $ ) {
  ...
  * =============================== */
  ...
  , enter: function ( e ) {
      var self = $(e.currentTarget)[this.type](this._options, this.name).data(this.name)
  ...
  * ========================= */
  ...
  $.fn.tooltip = function ( option, name ) {
    return this.each(function () {
      var $this = $(this)
        , tooltipName = (name) ? name : 'defaultTooltip'
        , data = $this.data(tooltipName)
        , options = typeof option == 'object' && option
      if (!data) $this.data(tooltipName, (data = new Tooltip(tooltipName, this, options)))
