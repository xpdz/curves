...
public class RedirectController {
    ...
    public String processData(@RequestParam("year") int year, @RequestParam("month") int month) throws Exception {
        CurvesParser cp = new CurvesParser(pjSumRepo, caRepo, year, month);
        cp.processCA();
        cp.processPJ();
        return "completed";
    }
